...
import { RiKeyLine, RiUser3Line } from "react-icons/ri";
...
const Index = () => {
  ...
  return (
    <Flex width="100%" height="100vh" {...backgroundColor}>
      <GlobalBackground />
      {isRedirect && <Loading />}
      <Flex bgColor={isDark ? theme[200] : theme[700]} flex={0.9}>
        <BackgroundIcon />
      </Flex>
      <Flex
        bgColor={isDark ? theme[700] : theme[200]}
        flex={1}
        direction="column"
        padding={8}
        borderLeftRadius="xl"
